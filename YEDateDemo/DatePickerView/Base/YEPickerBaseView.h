...
typedef void(^YECancelBlock)(void);
typedef void(^YEDoneClickBlock)(void);

@interface YEPickerBaseView : UIView
...
@property (nullable, nonatomic, strong) YEPickerStyle *pickerStyle;

/** 取消选择的回调 */
@property (nullable, nonatomic, copy) YECancelBlock cancelBlock;
...
@property (nullable, nonatomic, copy) YEDoneClickBlock doneBlock;
